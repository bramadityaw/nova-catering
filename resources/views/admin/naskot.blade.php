...
<body>
        ...
        <ul class="side-menu top">
            ...
            <li class="active">
                <a href="admin_naskot.html">
                    <img src="images/nasi_kotak_icon.png" class="logo" alt="" />
    ...
    <section id="content">
        ...
        <main>
            ...
            <div class="button_postingan">
                <a href="admin_add_naskot.html" id="addResepLink"><button><i class="bx bx-plus" id="add_artikel"></i>Tambah</button></a>
            </div>
            ...
            <ul class="box-info">
                <li>
                    <i class="bx bxs-bowl-rice" style="color: #487C07; background:#D0F89F;"></i>
                    <span class="text">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            const csvFilePath = 'naskot.csv'; // Path to your CSV file
            ...
            async function fetchCSVData() {
                ...
                rows.forEach(row => {
                    ...
                    if (columns.length > 1) { // Check if the row has valid data
                        const resep = {
                            id: columns[0],
                            judul_naskot: columns[1],
                            harga: columns[2],
                            gambar_nasi_kotak: columns[3],
                ...
                resepList.forEach((resep, index) => {
                    ...
                    newArticleCard.innerHTML = `
                        ...
                        <div class="card-title">
                            ...
                            <div class="title">
                                <p>Id Naskot: <span id="id_naskot">${resep.id}</span></p>
